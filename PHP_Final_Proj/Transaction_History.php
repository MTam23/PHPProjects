<!-- Creation Date: 9/25/2015
    ...
    Purpose: ELENGX400-002 PHP Programming for the Web
            Programming Final Project - transaction_history.php

This page displays all transactions made in the database and allows admins to
search by criteria.
-->
 ...
 ?>
	...
	<div id="formLeft"> 
		...
		<?php
            ...
            //call get_transactions() to print out selected transactions
